...
let letters =document.querySelectorAll(".letters>div");//button-lar
let nextWord =document.querySelector(".Next");//button
...
let boxes= document.querySelectorAll(".Letterss");
if (selectedWord.includes(e.target.textContent)) {//target array-ın hər bir elemenitini bir-bir log edir
for (let i=0; i < selectedWord.length; i++) {
